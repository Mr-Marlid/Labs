...
%1.1
pr1_1:- see('C:/Libs/Labs/Lab8/1.txt'),
	read_list_str(_, LengthList),
	seen,
...
%1.2
pr1_2:- see('C:/Libs/Labs/Lab8/1.txt'), read_list_str_space(_, C),
...
%1.3
pr1_3:- see('C:/Libs/Labs/Lab8/1.txt'), count_A(_,N,C), M is C/N,
	 seen, see('C:/Libs/Labs/Lab8/1.txt'), read_list_str_A(_,M), seen.
...
%1.4
pr1_4:- see('C:/Libs/Labs/Lab8/1.txt'), read_list_str1(List), seen,
...
%1.5
pr1_5:- see('C:/Libs/Labs/Lab8/1.txt'), read_list_str1(List), seen,
	unique_words(List,List,[],R), see('/1.txt'),
...
% 5
pr5:- see('C:/Libs/Labs/Lab8/1.txt'), read_list_str(List,LengthList), seen,
...
% 6
pr6:- see('C:/Libs/Labs/Lab8/1.txt'), read_str_count_words(List,CountWordsList),
...
% 7
pr7:- see('C:/Libs/Labs/Lab8/1.txt'), read_str_after(List,CountWordsList),
	seen, sort_list(List,CountWordsList,[],SList), write1(SList).
